...
interface SkincareStickyCtaProps {
  onOpenWizard: () => void;
}

export const SkincareStickyCta: React.FC<SkincareStickyCtaProps> = ({ onOpenWizard }) => {
        ...
        <>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <a
                href="https://wa.me/918796755169?text=Hi%20Mayank!%20I%20want%20to%20launch%20my%20skincare%20brand%20with%20Banega."
                target="_blank"
                rel="noreferrer"
          ...
          >
            <button
              type="button"
              onClick={onOpenWizard}
              className="group inline-flex items-center gap-2.5 px-6 py-3.5 rounded-full bg-black hover:bg-zinc-800 text-white font-semibold text-xs uppercase tracking-wider shadow-2xl border border-zinc-700 transition-all duration-200 active:scale-95 cursor-pointer select-none"
              style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}
            >
...
export default SkincareStickyCta;
